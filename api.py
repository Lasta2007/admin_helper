...
def api_aldpro_tree_settings_get():
    """Получить настройки дерева ALD Pro (базовый OU) нового модуля."""
    return sync360_new.get_ald_sync_settings()


@router.post("/yandex360/aldpro/tree/settings")
